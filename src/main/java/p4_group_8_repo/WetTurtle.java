...
public class WetTurtle extends Turtle{
	...
	public void animationCompile(){
		...
		Image firstFrame = new Image("file:src/main/resources/TurtleAnimation2Wet.png", size, size, true, true);
		Image secondFrame = new Image("file:src/main/resources/TurtleAnimation3Wet.png", size, size, true, true);
		Image thirdFrame = new Image("file:src/main/resources/TurtleAnimation4Wet.png", size, size, true, true);
