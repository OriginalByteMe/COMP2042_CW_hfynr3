...
//    digitToWindow();
    ...
    public void carToWindow() {
        obstacleFactory.setImageLink("file:src/Resources/car1Left.png");
    ...
    public void turtleToWindow() {
        obstacleFactory.setImageLink("file:src/Resources/TurtleAnimation2.png");
    ...
    public void truckSmallToWindow() {
        obstacleFactory.setImageLink("file:src/Resources/truck1" + "Right.png");
        obstacleFactory.setSize(120);
        obstacleFactory.setShift(300);
        obstacleFactory.AddToWindow(game);
    }
    public void truckBigToWindow() {
        obstacleFactory.setImageLink("file:src/Resources/truck2Right.png");
    ...
    public void logSmallToWindow() {
        obstacleFactory.setImageLink("file:src/Resources/logs.png");
    ...
    public void logBigToWindow() {
        obstacleFactory.setImageLink("file:src/Resources/log3.png");
